...
var_scores1 <- scores(peri_are.rda, scaling = 1)$biplot|>as_tibble(rownames = "Env_Variable")
...
site_scores2 <- scores(peri_are.rda, scaling = 2)$sites|>as_tibble()|>
  mutate(Site = peri_group_com_are$Site, .before = RDA1)
var_scores2 <- scores(peri_are.rda, scaling = 2)$biplot|>as_tibble(rownames = "Env_Variable")


ggplot()+
  geom_text(data = fa_scores1, aes(x = RDA1, y = RDA2, label = FA), color = "red")+
  geom_text(data = site_scores1, aes(x = RDA1, y = RDA2, label = Site))+
  geom_segment(data = var_scores1, aes(x = 0, y = 0, xend = RDA1, yend = RDA2))


ggplot()+
  geom_text(data = fa_scores2, aes(x = RDA1, y = RDA2, label = FA), color = "red")+
  geom_text(data = site_scores2, aes(x = RDA1, y = RDA2, label = Site))+
  geom_segment(data = var_scores2, aes(x = 0, y = 0, xend = RDA1, yend = RDA2))
```
