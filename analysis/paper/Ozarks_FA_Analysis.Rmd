...
peri_areal_lms <- FA_groups_areal|>
  ...
  summarize(glance(model), 
            ...
            #partr2_summary = list(tidy(partR2::partR2(model))),
...
lmm1 <- ffg_inverts|>
  ...
  mutate(#model = list(lmer(FA_per ~ Canopy_Cover_per*FFG+NO3_ug.L*FFG+(1|Taxon), data = data)),
         model = list(lm(FA_per ~ Canopy_Cover_per*NO3_ug.L+Taxon, data = data)),
         model_reduced = list(lm(FA_per ~ Canopy_Cover_per*NO3_ug.L, data = data)),
